...
const CERTS: CertInfo[] = [
  ...
  },
  {
    ...
    questions: '60',
    duration: '120 min',
    focus: 'End-to-end ML on Google Cloud: architect, prepare data, develop models, serve at scale, automate pipelines, monitor and maintain',
    domains: [
      { name: 'Architect ML Solutions',                   pct: '13%' },
      { name: 'Prepare and Process Data',                 pct: '18%' },
      { name: 'Develop ML Models',                        pct: '18%' },
      { name: 'Serve and Scale ML Models',                pct: '19%' },
      { name: 'Automate and Orchestrate ML Pipelines',    pct: '20%' },
      { name: 'Monitor, Optimize & Maintain ML Solutions',pct: '12%' },
    ],
    topTopics: ['Vertex AI', 'Vertex AI Feature Store', 'Vertex AI Pipelines', 'TFX', 'BigQuery ML', 'Model monitoring', 'Distributed training', 'Vertex AI Explanations', 'MLOps', 'Vertex AI Vector Search'],
  },
  {
    id: 'GIAC-GOAA',
