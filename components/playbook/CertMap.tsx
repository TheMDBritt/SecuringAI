...
const CERTS: CertInfo[] = [
  {
    ...
    domains: [
      { name: 'Basic AI concepts related to cybersecurity', pct: '17%' },
      { name: 'Securing AI systems',                        pct: '40%' },
      { name: 'AI-assisted security',                       pct: '24%' },
      { name: 'AI governance, risk, and compliance',        pct: '19%' },
    ],
  ...
  },
  {
    ...
    provider: 'Microsoft',
    tagColor: 'bg-brand-500/10 text-brand-400 border-brand-500/30',
    difficulty: 'Foundational',
    questions: '40-60',
    duration: '45 min',
