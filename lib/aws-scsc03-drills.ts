...
export const AWS_SCSC03_DRILLS: Drill[] = [
  ...
  // ── Domain 1 (IAM) - Drill 1: Policy evaluation & permission boundaries ─────
  {
    ...
    difficulty: 'advanced',
    objectives: ['SCS-C03 Domain 4: Identity and Access Management'],
    steps: [
      {
  ...
  // ── Domain 2 (Infrastructure Security) — Drill 1: VPC isolation ──────────────
  {
    ...
    difficulty: 'intermediate',
    objectives: ['SCS-C03 Domain 3: Infrastructure Security'],
    steps: [
      {
  ...
  // ── Domain 3 (Data Protection) — Drill 1: KMS key policy + IAM ──────────────
  {
    ...
    difficulty: 'advanced',
    objectives: ['SCS-C03 Domain 5: Data Protection'],
    steps: [
      {
        screen: 'AWS KMS · Keys',
  ...
  // ── Domain 4 (Security Logging & Monitoring) — Drill 1: CloudTrail ─────────
  {
    ...
    difficulty: 'intermediate',
    objectives: ['SCS-C03 Domain 1: Detection'],
    steps: [
      {
  ...
  // ── Domain 5 (Threat Detection & Incident Response) — Drill 1: GuardDuty ─────
  {
    ...
    difficulty: 'intermediate',
    objectives: ['SCS-C03 Domain 2: Incident Response'],
    steps: [
      {
  ...
  // ── Domain 6 (Management & Governance) — Drill 1: AWS Config ─────────────────
  {
    ...
    difficulty: 'beginner',
    objectives: ['SCS-C03 Domain 6: Security Foundations and Governance'],
    steps: [
      {
