    ...
    domains: [
      {
        ...
        topics:     ['AI-Powered SIEM', 'Detection Rules'],
      },
      {
        name:       'Vulnerability Discovery Automation',
        topics:     ['Attacks', 'OWASP LLM Top 10'],
      },
      {
        name:       'AI-Driven Attack Simulations',
        categories: ['Red Teaming AI'],
        topics:     ['AI Red Teaming', 'Adversarial Attacks', 'Agentic Attacks'],
      },
      {
      ...
      },
      {
        ...
        topics:     ['CI/CD for ML', 'MLOps Security'],
        categories: ['Computer Vision', 'NLP'],
      },
    ],
  },
