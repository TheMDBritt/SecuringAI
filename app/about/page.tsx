...
export const metadata = {
  ...
  description:
    'How LLM DOJO works: deterministic scoring, quality rubrics, quiz flow, and the AI security certifications mapped across 37 scenarios, 1,248+ quiz questions, and 664+ glossary terms.',
};
