    ...
    <div className="flex flex-col">
      ...
      <section className="border-b border-slate-800">
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <h2 className="text-xl font-bold text-slate-100 mb-6">
            {`Three connected dojos. ${SCENARIOS.length} scenarios. 27 prebuilt Dojo 2 incidents.`}
          </h2>
          <div className="space-y-5 text-sm text-slate-400 leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <p>
                ...
                {SCENARIO_COUNT_BY_DOJO[2]} scenario types, 27 prebuilt incidents plus on-demand
