...
export const metadata = {
  title: 'About',
  description:
    'Why LLM DOJO exists and how it works. Free, login-free AI security training across 29 scenarios, 1,158 quiz questions, 645 glossary terms, 71 articles, and 10 AI security certifications.',
};
