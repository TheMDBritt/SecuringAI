...
export const metadata = {
  title: 'About',
  description:
    'Why LLM DOJO exists and how it works. Free, login-free AI security training across 26 scenarios, 856 quiz questions, 491 glossary terms, and 10 AI security certifications.',
};
