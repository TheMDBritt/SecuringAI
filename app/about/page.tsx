...
export const metadata = {
  ...
  description:
    'How LLM DOJO works: deterministic scoring, quality rubrics, quiz flow, and the AI security certifications mapped across 40 scenarios, 1,263+ quiz questions, and 709+ glossary terms.',
};
