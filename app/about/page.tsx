...
export const metadata = {
  title: 'About',
  description:
    'Why LLM DOJO exists and how it works. Free, login-free AI security training across 27 scenarios, 1,100+ quiz questions, 595+ glossary terms, and 10 AI security certifications.',
};
        ...
        <div className="max-w-4xl mx-auto px-6 py-14">
          ...
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-px bg-slate-800 border border-slate-800 rounded-lg overflow-hidden">
            {[
              ...
              { n: '1,100+',                 label: 'Quiz questions',     sub: '10 certs, all domains'   },
              { n: '595+',                   label: 'Glossary terms',     sub: 'cert-tagged, searchable' },
