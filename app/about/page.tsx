...
export const metadata = {
  title: 'About',
  description:
    'Why LLM DOJO exists and how it works. Free, login-free AI security training across 27 scenarios, 1025 quiz questions, 562 glossary terms, and 10 AI security certifications.',
};
