...
export const metadata = {
  title: 'Dashboard',
  description:
    'Your executive AI security training dashboard — completion, attack defense rate, quiz accuracy, difficulty distribution, recent activity, and recommended next lab.',
};
