...
const TECHNIQUES = [
  { label: 'Prompt Injection',           tag: 'LLM01:2025',    dojo: 1 },
  { label: 'Improper Output Handling',   tag: 'LLM05:2025',    dojo: 1 },
  { label: 'Training Data Poisoning',    tag: 'LLM04:2025',    dojo: 1 },
  { label: 'Supply Chain Risk',          tag: 'LLM03:2025',    dojo: 1 },
  { label: 'Sensitive Data Leak',        tag: 'LLM02:2025',    dojo: 1 },
  { label: 'System Prompt Leakage',      tag: 'LLM07:2025',    dojo: 1 },
  { label: 'Excessive Agency',           tag: 'LLM06:2025',    dojo: 1 },
  { label: 'RAG / Vector Attacks',       tag: 'LLM08:2025',    dojo: 1 },
  { label: 'Misinformation',             tag: 'LLM09:2025',    dojo: 1 },
  { label: 'Model Theft',                tag: 'LLM10:2025',    dojo: 1 },
  { label: 'Indirect Injection',         tag: 'AML.T0054.001', dojo: 1 },
  { label: 'Model Inversion',            tag: 'AML.T0024',     dojo: 1 },
  { label: 'Vector DB Poisoning',        tag: 'LLM08:2025',    dojo: 1 },
  { label: 'Confused Deputy',            tag: 'LLM06:2025',    dojo: 1 },
  { label: 'MCP Server Hijack',          tag: 'LLM07+LLM06',   dojo: 1 },
  ...
  { label: 'Semantic Cache Poisoning',   tag: 'LLM08:2025',    dojo: 1 },
  ...
  { label: 'Supply Chain Poisoning',     tag: 'LLM03:2025',    dojo: 1 },
  { label: 'Agent Forensics',            tag: 'AML.T0051',     dojo: 2 },
  { label: 'AI Continuous Monitoring',   tag: 'ISO 42001',     dojo: 3 },
  { label: 'Tool Call Injection',        tag: 'LLM06:2025',    dojo: 1 },
  { label: 'Zero-Width Steganography',   tag: 'LLM01:2025',    dojo: 1 },
  { label: 'Markdown Rendering Attack',  tag: 'LLM05:2025',    dojo: 1 },
  ...
  { label: 'PyRIT Red Teaming',          tag: 'GOAA+GASAE',    dojo: 1 },
